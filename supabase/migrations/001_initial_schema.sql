...
-- ou através do CLI do Supabase.
-- ============================================================================

-- ============================================================================
-- ENUMS (Tipos Enum)
-- ============================================================================
-- Usando DO blocks para criar apenas se não existirem
...
-- ============================================================================
-- NOTA: Este sistema usa autenticação customizada via tabela usuarios,
-- então as políticas permitem acesso total. Em produção, você pode querer
-- refinar essas políticas baseadas na sua lógica de autenticação.
